...
| 27 | `20260911-20-ODUNZE-CONTINGENCY.md` | **Current. START HERE.** No code. Kicker gap **fully closed** — waiver processed, McLaughlin rostered and slotted at K; roster 15, Week 1 starters ~100 proj (was 91.6 with K empty). One live decision left: **Sun 09-13 before 13:00 ET, check Odunze (`Q`) -> start Sutton (DEN @ KC, Mon 20:15) if out.** Swap legal all Sunday morning because Sutton's game is later; mis-swap costs 0.4 pts, so start Sutton on any real doubt. Lineup otherwise settled, do not re-litigate. #24 §7 `CLAUDE.md` staleness ("Phase 0", "17 rounds") still **unfixed**; weekly picker still the next build. |
